...
import com.coolweather.android.view.CircleIndexView;
import com.coolweather.android.view.SunView;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    private void showWeatherInfo(Weather weather){
        ...
        if(weather.aqi != null){
            circleIndexView.updateIndex(Integer.valueOf(weather.aqi.city.aqi),"良");
...
//        String wind_String=now.getWind_dir()+weather.getNow().getWind_sc()
//                +"级";
...
//        String pa_String=now.getPressure()+" hpa";
        windText.setText("10");
        humText.setText("35");
        body_tmpText.setText("36");
        sunsetText.setText("19:00");
        sunriseText.setText("6:00");
        paText.setText("2");

        sunView.setTimes("6:00","19:00",updateTime);
